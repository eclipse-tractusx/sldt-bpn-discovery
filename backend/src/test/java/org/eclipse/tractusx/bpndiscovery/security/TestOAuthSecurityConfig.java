...
public class TestOAuthSecurityConfig {
   ...
   @Bean
   public TestJwtTokenFactory jwtTokenFactory( BpnDiscoveryProperties bpnDiscoveryProperties ) {

      String defaultBpn = "DEFAULT_BPN";
      return new TestJwtTokenFactory(
            bpnDiscoveryProperties.getIdm().getPublicClientId(), defaultBpn
      );
   }
